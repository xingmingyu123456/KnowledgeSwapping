...
def split_dataset(
    dataset, class_order_list, split1_start, split1_end, split2_start, split2_end,data_transform
):
    # get the number of classes
    num_classes = len(dataset.classes)
    class_order_list = [i for i in range(100)]
    ...
    split1_dataset = ImageFolder(root=dataset.root, transform=data_transform)
    ...
    split2_dataset = ImageFolder(root=dataset.root, transform=data_transform)
