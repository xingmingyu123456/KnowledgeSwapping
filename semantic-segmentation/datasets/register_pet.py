...
def register_pet(image_dir,annotation_dir,image_dir_val,annotation_dir_val):
    ...
    # thing_classes = ['wall', 'building', 'sky', 'floor', 'tree', 'ceiling', 'road, route', 'bed', 'window ', 'grass', 'cabinet',
    ...
    #  'glass, drinking glass', 'clock', 'flag',"bird","cat","cow","dog","horse","sheep","a","b","c","d"]
    ...
    thing_classes = ['wall', 'building', 'sky', 'floor', 'tree', 'ceiling', 'road', 'bed', 'window ', 'grass',
                     ...
                     'radiator',
                     'glass', 'clock', 'flag', "Abyssinian","american_bulldog","american_pit_bull_terrier","basset_hound","beagle","Bengal", "a", "b",
                     "c", "d"]
