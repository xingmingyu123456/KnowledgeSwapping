...
def load_ade20k_sem_seg(split,image_dir,annotation_dir):

    # if split == "train":
    #     image_dir = imge_dir
    #     sem_seg_dir = annotation_dir
    # elif split == "val":
    #     image_dir = imge_dir
    #     sem_seg_dir = annotation_dir
    # else:
    ...
    for file_name in os.listdir(image_dir):
        ...
        seg_path = os.path.join(annotation_dir, file_name.replace(".jpg", ".png"))
...
def register_forget_ade(image_dir, annotation_dir, image_dir_val, annotation_dir_val):
    # 注册数据集


    DatasetCatalog.register(
        "forget_dataset_train",
    ...
    #
    # thing_colors = generate_fixed_colors(len(thing_classes))
