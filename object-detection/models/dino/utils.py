...
class MLP(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, output_dim, num_layers,lora_rank=8,lora_pos="FFN"):
        super().__init__()
        self.num_layers = num_layers
        h = [hidden_dim] * (num_layers - 1)
        self.layers = nn.ModuleList(lora.Linear(n, k,r=(lora_rank if lora_pos=="FFN" else 0)) for n, k in zip([input_dim] + h, h + [output_dim]))
